      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p>Todos los campos son obligatorios. Fijaros en la foto, esta relleno pero podreís agregar algún nombre</p>
          </div>
        </div>
      </div>
    </div><!-- End Page Header -->
...
<section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-9">
            <!--  //TODO examen -->
            <form action="./c_crearAnimal.php?zoo_id=<?php echo $zoo_id?>" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="nombre" class="form-control" id="nombre" placeholder="Nombre" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="nombre_cientifico" id="nombre_cientifico" placeholder="Nombre cientifico" required>
                </div>
              </div>
              ...
              <div class="form-group mt-3">
                <input type="text" class="form-control" name="foto" id="foto" placeholder="foto" value="https://loremflickr.com/320/240/" required>
              </div>
